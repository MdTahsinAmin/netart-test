...
const Product = () => {
    ...
    <div className='container'>
        <p>Installed over 10 lakhs star rated pumpsets across the country resulting in a cumulative saving of more then 900 million units of power for the nation.</p> <br/>
